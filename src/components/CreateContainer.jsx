...
import { getAllShoesItem, saveItem } from '../utils/firebaseFunctions';
...
const CreateContainer = () => {
  ...
  const saveDetails = () => {
    setIsLoading(true);
    try {
      if ((!title || !details || !imageAsset || !price || !category)) {
        setFields(true);
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      ...
      items-center justify-center gap-4">
        ...
        <div className="w-full py-2 px-2 border-b border-gray-300 flex items-center gap-2">
        ...
        <div className="w-full">
          ...
          >
            ...
            {categories && categories.map(item => (
              <option
                key={item.id}
                className="text-base border-0 outline-nonencapitalize 
        ...
        <div className=" flex items-center w-full">
          <button
            ...
            border-non outline-none bg-emerald-500 px-12 py-2 rounded-lg text-lg
