                ...
                <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
                    ...
                    justify-evenly px-8 py-2">
                        <div className="w-full flex items-center justify-between">
                            ...
                            <p className="text-gray-400 text-lg">₱ {tot}.00</p>
                        </div>
                        <div className="w-full flex items-center justify-between">
                            <p className="text-gray-400 text-lg">Delivery Fee</p>
                            <p className="text-gray-400 text-lg">₱ 49.00</p>
                        </div>

                        <div className="w-full border-b border bg-gray-600 my-2"></div>

                        <div className="w-full flex items-center justify-between">
                            <p className="text-gray-200 text-xl font-semibold">Total:</p>
                            <p className="text-gray-200 text-xl font-semibold">₱ {tot + 49}.00</p>
                        </div>
